  ...
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-84px)] space-y-6">
      <div className="w-full max-w-md space-y-4 border-t border-border pt-6">
        <h3 className="text-lg font-semibold text-foreground text-center">Withdraw SOL</h3>
        ...
        <div className="grid grid-cols-4 gap-4">
          {PRESET_AMOUNTS.map((preset) => (
            <button
              ...
              className={`rounded border py-2 text-md font-semibold transition ${
                selectedPreset === preset
                  ? "bg-foreground/10 border-primary"
